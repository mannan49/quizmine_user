...
function ResultComponent() {
  ...
  return (
    <div className="flex px-4 pt-2 pb-16 lg:pb-0 flex-col items-center lg:flex-row justify-around  w-full ">
      <div className="bg-main border-none rounded-xl lg:mt-0 mb-4 px-8 py-4 w-full lg:w-1/3">
      ...
      {/* <div>
        <h1 className="bg-primary px-2 py-2 text-main text-center rounded-xl">
          We hope you enjoyed our services. Best wishes for your future.
        </h1>
      </div> */}
    </div>
  );
